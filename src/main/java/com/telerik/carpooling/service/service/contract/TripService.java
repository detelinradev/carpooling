...
public interface TripService {
     ...
     *
     * @param tripDtoRequest     DTO that holds required data for creating <class>trip</class> object
     ...
     * @return instance of the created <class>trip</class> mapped as <class>TripDtoResponse</class>
     ...
     * @return instance of the updated <class>trip</class> mapped as <class>TripDtoResponse</class>
     */
     ...
     * <p>
     *     In case the logged <class>user</class> is not the owner of the <class>trip</class> exception is thrown with
     * relevant message.
     * <p>
     *     Various stages should be logically connected and if case there is mismatch exception is thrown with matching
     * message. Accepted paths are AVAILABLE-BOOKED-ONGOING-DONE, CANCEL is accepted in all stages except after DONE.
     *
